...
var app = (function () {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			section.textContent = "Index Page";
    			add_location(section, file, 6, 0, 29);
    		},
    		l: function claim(nodes) {
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			h2 = element("h2");
    			h2.textContent = "The mentality of musing while meandering";
    			t3 = space();
    			a0 = element("a");
    			...
    			add_location(h1, file$1, 7, 2, 41);
    			add_location(h2, file$1, 8, 2, 90);
    			attr_dev(a0, "href", "https://www.linkedin.com/in/mtempleheald");
    			attr_dev(a0, "target", "_blank");
    			add_location(a0, file$1, 9, 2, 143);
    			attr_dev(a1, "href", "https://mtempleheald.github.io");
    			attr_dev(a1, "target", "_blank");
    			add_location(a1, file$1, 10, 2, 235);
    			attr_dev(a2, "href", "https://github.com/mtempleheald");
    			attr_dev(a2, "target", "_blank");
    			add_location(a2, file$1, 11, 2, 304);
    			add_location(header, file$1, 6, 0, 29);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$3 = "src\\components\\Topic.svelte";
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(section, file$3, 6, 0, 29);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$4 = "src\\components\\Blog.svelte";
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(section, file$4, 6, 0, 29);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(meta0, file$5, 32, 2, 772);
    			attr_dev(meta1, "name", "description");
    			attr_dev(meta1, "content", "MTH on the web");
    			add_location(meta1, file$5, 33, 1, 822);
    			attr_dev(main, "class", "svelte-2phdd8");
    			add_location(main, file$5, 37, 0, 907);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
