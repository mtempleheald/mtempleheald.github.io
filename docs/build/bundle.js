    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 8, 1, 78);
    			add_location(p, file, 9, 1, 94);
    			add_location(section, file, 6, 0, 64);
    		},
    		l: function claim(nodes) {
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$5, 7, 2, 42);
    			add_location(p, file$5, 8, 2, 69);
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(meta0, file$6, 33, 2, 836);
    			attr_dev(meta1, "name", "description");
    			attr_dev(meta1, "content", "MTH on the web");
    			add_location(meta1, file$6, 34, 1, 886);
    			attr_dev(main, "class", "svelte-2phdd8");
    			add_location(main, file$6, 38, 0, 971);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
