...
var app = (function () {
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(li0, "class", "svelte-4nyeo0");
    			add_location(li0, file$3, 11, 4, 136);
    			attr_dev(li1, "class", "svelte-4nyeo0");
    			add_location(li1, file$3, 12, 4, 175);
    			attr_dev(li2, "class", "svelte-4nyeo0");
    			add_location(li2, file$3, 13, 4, 218);
    			attr_dev(ul, "class", "svelte-4nyeo0");
    			add_location(ul, file$3, 10, 2, 126);
    			attr_dev(nav, "class", "svelte-4nyeo0");
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$4, 8, 2, 81);
    			attr_dev(h2, "class", "svelte-1lrvsco");
    			add_location(h2, file$4, 9, 2, 111);
    			add_location(header, file$4, 7, 0, 69);
    			attr_dev(div, "class", "svelte-1lrvsco");
    			add_location(div, file$4, 6, 0, 62);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p0, file$5, 6, 2, 39);
    			add_location(p1, file$5, 7, 2, 111);
    			attr_dev(a0, "href", "https://www.linkedin.com/in/mtempleheald");
    			attr_dev(a0, "target", "_blank");
    			add_location(a0, file$5, 8, 2, 179);
    			attr_dev(a1, "href", "https://mtempleheald.github.io");
    			attr_dev(a1, "target", "_blank");
    			add_location(a1, file$5, 9, 2, 271);
    			attr_dev(a2, "href", "https://github.com/mtempleheald");
    			attr_dev(a2, "target", "_blank");
    			add_location(a2, file$5, 10, 2, 340);
    			attr_dev(footer, "class", "svelte-f6r59l");
    			add_location(footer, file$5, 5, 0, 27);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_default_slot_1$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h1 = element("h1");
    			t0 = text("Blog post ");
    			t1 = text(/*blogRoute*/ ctx[0]);
    			t2 = space();
    			p = element("p");
    			t3 = text("TODO use snarkdown to render markdown file based on passed id = ");
    			t4 = text(t4_value);
    			add_location(h1, file$6, 9, 4, 151);
    			add_location(p, file$6, 10, 4, 187);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*blogRoute*/ 1) set_data_dev(t1, /*blogRoute*/ ctx[0]);
    			if (dirty & /*params*/ 2 && t4_value !== (t4_value = /*params*/ ctx[1].id + "")) set_data_dev(t4, t4_value);
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(9:2) <Route path=\\\":id\\\" let:params>",
    		ctx
    	});
    ...
    function create_default_slot$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h1 = element("h1");
    			h1.textContent = "Blogs to be listed here";
    			add_location(h1, file$6, 13, 4, 306);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h1, anchor);
    		},
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(article, file$6, 7, 0, 103);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*$$scope, params, blogRoute*/ 7) {
    ...
    function instance$6($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Route, Link, blogRoute });
    ...
    function create_default_slot_1$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h1 = element("h1");
    			t0 = text("Topic ");
    			t1 = text(/*topicRoute*/ ctx[0]);
    			t2 = space();
    			p = element("p");
    			t3 = text("TODO use snarkdown to render markdown file based on passed id = ");
    			t4 = text(t4_value);
    			add_location(h1, file$7, 9, 4, 152);
    			add_location(p, file$7, 10, 4, 185);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h1, anchor);
    			append_dev(h1, t0);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*topicRoute*/ 1) set_data_dev(t1, /*topicRoute*/ ctx[0]);
    			if (dirty & /*params*/ 2 && t4_value !== (t4_value = /*params*/ ctx[1].id + "")) set_data_dev(t4, t4_value);
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(h1);
    ...
    function create_default_slot$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h1 = element("h1");
    			h1.textContent = "Topics to be listed here";
    			add_location(h1, file$7, 13, 4, 304);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h1, anchor);
    		},
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = space();
    			create_component(route1.$$.fragment);
    			add_location(article, file$7, 7, 0, 104);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*$$scope, params, topicRoute*/ 7) {
    				route0_changes.$$scope = { dirty, ctx };
    			}
    ...
    function instance$7($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Route, Link, topicRoute });
    ...
    function create_default_slot_1$3(ctx) {
    	let html_tag;
    	let raw_value = t(/*notFound*/ ctx[1]) + "";
    	let html_anchor;
    ...
    function create_default_slot$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(main, "class", "svelte-1jrex9l");
    			add_location(main, file$8, 39, 2, 1059);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(meta0, file$8, 33, 2, 911);
    			attr_dev(meta1, "name", "description");
    			attr_dev(meta1, "content", "MTH on the web");
    			add_location(meta1, file$8, 34, 1, 961);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
