...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(h1, file, 7, 0, 106);
			add_location(p0, file, 8, 0, 131);
			add_location(code, file, 9, 12, 193);
			add_location(p1, file, 9, 0, 181);
		},
...
//# sourceMappingURL=_fallback-7577599c.js.map
