  ...
  "children": [
    {
      ...
      "path": "/_fallback",
      "id": "__fallback",
      "component": () => import('./_fallback-95dd2895.js').then(m => m.default)
    },
    {
      "isFile": true,
      "isDir": false,
      ...
      "path": "/",
      "id": "__layout",
      "component": () => import('./_layout-6f263139.js').then(m => m.default)
    },
    {
      "isFile": false,
      "isDir": true,
      ...
      "children": [
        {
          ...
          "path": "/blog/:slug",
          "id": "_blog__slug",
          "component": () => import('./[slug]-3493805a.js').then(m => m.default)
        },
        {
          "isFile": true,
          "isDir": false,
          ...
          "path": "/blog/index",
          "id": "_blog_index",
          "component": () => import('./index-31be8db2.js').then(m => m.default)
        }
      ],
      "isLayout": false,
      "isReset": false,
    ...
    },
    {
      ...
      "ext": "svelte",
      "badExt": false,
      "absolutePath": "C:/Workspace/github/mtempleheald/mtempleheald.github.io/src/pages/Footer.svelte",
      ...
      "path": "/Footer",
      "id": "_Footer",
      "component": () => import('./Footer-b2967b55.js').then(m => m.default)
    },
    {
      "isFile": true,
      "isDir": false,
      "file": "Header.svelte",
      "filepath": "/Header.svelte",
      "name": "Header",
      "ext": "svelte",
      "badExt": false,
      "absolutePath": "C:/Workspace/github/mtempleheald/mtempleheald.github.io/src/pages/Header.svelte",
      "importPath": "../../../../src/pages/Header.svelte",
      "isLayout": false,
      "isReset": false,
      "isIndex": false,
      "isFallback": false,
      ...
      "path": "/Header",
      "id": "_Header",
      "component": () => import('./Header-6f26060c.js').then(m => m.default)
    },
    {
      "isFile": true,
      "isDir": false,
      ...
      "path": "/index",
      "id": "_index",
      "component": () => import('./index-14d9f9d4.js').then(m => m.default)
    },
    {
      "isFile": false,
      "isDir": true,
      ...
      "children": [
        {
          ...
          "path": "/topic/index",
          "id": "_topic_index",
          "component": () => import('./index-a0c9a07d.js').then(m => m.default)
        }
      ],
      "isLayout": false,
      "isReset": false,
...
function create_fragment$3(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(meta0, file$2, 10, 2, 242);
			attr_dev(meta1, "name", "description");
			attr_dev(meta1, "content", "MTH on the web");
			add_location(meta1, file$2, 11, 1, 292);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
//# sourceMappingURL=main-77e33deb.js.map
