...
import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, g as validate_each_argument, h as validate_store, u as url, j as component_subscribe, k as isActive, v as validate_slots, e as element, t as text, l as attr_dev, m as toggle_class, b as add_location, c as insert_dev, o as append_dev, f as detach_dev, a as space, n as noop, p as destroy_each, q as create_component, w as mount_component, x as transition_in, y as transition_out, z as destroy_component, A as create_slot, B as update_slot } from './main-43ee5503.js';
...
function create_fragment$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(h1, "class", "svelte-u8y687");
			add_location(h1, file$1, 8, 2, 81);
			attr_dev(h2, "class", "svelte-u8y687");
			add_location(h2, file$1, 9, 2, 111);
			attr_dev(header, "class", "svelte-u8y687");
			add_location(header, file$1, 7, 0, 69);
			attr_dev(div, "class", "svelte-u8y687");
...
//# sourceMappingURL=_layout-dc4690b5.js.map
