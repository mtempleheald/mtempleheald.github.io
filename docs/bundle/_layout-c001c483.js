...
import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, m as validate_each_argument, v as validate_store, u as url, c as component_subscribe, o as isActive, a as validate_slots, e as element, t as text, p as attr_dev, q as toggle_class, f as add_location, h as insert_dev, j as append_dev, l as detach_dev, n as noop, w as destroy_each, b as space, x as create_slot, y as create_component, z as mount_component, A as update_slot, B as transition_in, C as transition_out, D as destroy_component } from './main-c45419f8.js';
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(nav, "class", "svelte-1kwc04v");
...
function create_fragment$3(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(main, file$3, 10, 0, 173);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
function instance$3($$self, $$props, $$invalidate) {
	...
	$$self.$capture_state = () => ({ Nav, Header, Footer });
	return [$$scope, slots];
}
...
//# sourceMappingURL=_layout-c001c483.js.map
