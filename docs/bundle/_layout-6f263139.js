...
import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, m as validate_each_argument, v as validate_store, u as url, c as component_subscribe, o as isActive, a as validate_slots, e as element, t as text, p as attr_dev, q as toggle_class, f as add_location, h as insert_dev, j as append_dev, l as detach_dev, n as noop, w as destroy_each, x as create_slot, y as create_component, b as space, z as mount_component, A as update_slot, B as transition_in, C as transition_out, D as destroy_component } from './main-77e33deb.js';
import Header from './Header-6f26060c.js';
import Footer from './Footer-b2967b55.js';
...
function create_fragment$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(main, file$1, 10, 0, 171);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
//# sourceMappingURL=_layout-6f263139.js.map
