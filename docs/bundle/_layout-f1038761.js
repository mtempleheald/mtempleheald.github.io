...
import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, g as validate_each_argument, h as validate_store, u as url, j as component_subscribe, k as isActive, v as validate_slots, e as element, t as text, l as attr_dev, m as toggle_class, b as add_location, c as insert_dev, o as append_dev, f as detach_dev, a as space, n as noop, p as destroy_each, q as create_component, w as mount_component, x as transition_in, y as transition_out, z as destroy_component, A as create_slot, B as update_slot } from './main-30bad9fd.js';
...
function create_each_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(a, "class", "svelte-1ucfabm");
			toggle_class(a, "selected", /*$isActive*/ ctx[1](/*path*/ ctx[3]));
			add_location(a, file, 15, 8, 243);
			attr_dev(li, "class", "svelte-1ucfabm");
			add_location(li, file, 15, 4, 239);
		},
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(a, "href", "/");
			attr_dev(a, "class", "svelte-1ucfabm");
			add_location(a, file, 13, 8, 173);
			attr_dev(li, "class", "svelte-1ucfabm");
			add_location(li, file, 13, 4, 169);
			attr_dev(ul, "class", "svelte-1ucfabm");
			add_location(ul, file, 12, 2, 159);
			attr_dev(nav, "class", "svelte-1ucfabm");
			add_location(nav, file, 11, 0, 150);
		},
...
function instance($$self, $$props, $$invalidate) {
	...
	const links = [["./topic", "topic"], ["./blog", "blog"]];
...
function create_fragment$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(h1, "class", "svelte-bdking");
			add_location(h1, file$1, 8, 2, 81);
			attr_dev(h2, "class", "svelte-bdking");
			add_location(h2, file$1, 9, 2, 111);
			attr_dev(header, "class", "svelte-bdking");
			add_location(header, file$1, 7, 0, 69);
			attr_dev(div, "class", "svelte-bdking");
...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(hr, file$2, 5, 0, 27);
			add_location(p0, file$2, 7, 2, 46);
			add_location(p1, file$2, 8, 2, 118);
			attr_dev(a0, "href", "https://www.linkedin.com/in/mtempleheald");
			attr_dev(a0, "target", "_blank");
			add_location(a0, file$2, 9, 2, 186);
			attr_dev(a1, "href", "https://mtempleheald.github.io");
			attr_dev(a1, "target", "_blank");
			add_location(a1, file$2, 10, 2, 278);
			attr_dev(a2, "href", "https://github.com/mtempleheald");
			attr_dev(a2, "target", "_blank");
			add_location(a2, file$2, 11, 2, 347);
			add_location(footer, file$2, 6, 0, 34);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
function create_fragment$3(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(main, "class", "svelte-19hhe6o");
...
//# sourceMappingURL=_layout-f1038761.js.map
