...
Render Procedure/Function Name = true_breadcrumbs.render</p> <h3>The Code</h3> <h5>Page 0 Region Position 02 (didn’t have to be here)</h5> <ul><li>Identification > Title: True Breadcrumbs</li> <li>Identification > Type: True Breadcrumbs [Plug-In]</li> <li>Header and Footer > Header Text (this is only a demo, I wouldn’t normally add CSS directly in the HTML)</li></ul> <pre class="language-html"><!></pre> <h5>Package header</h5> <pre class="language-sql"><!></pre> <h5>Package body</h5> <pre class="language-sql"><!></pre>`,1);function N(r){var c=h(),e=a(m(c),16),i=n(e);p(i,()=>`<code class="language-sql"><span class="token keyword">FUNCTION</span> render <span class="token punctuation">(</span>p_region              <span class="token operator">IN</span> apex_plugin<span class="token punctuation">.</span>t_region
  ...
  <span class="token keyword">RETURN</span> apex_plugin<span class="token punctuation">.</span>t_region_render_result</code>`),s(e);var t=a(e,10),u=n(t);p(u,()=>`<code class="language-html"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>style</span> <span class="token attr-name">type</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>text/css<span class="token punctuation">"</span></span><span class="token punctuation">></span></span><span class="token style"><span class="token language-css">
  ...
  <span class="token selector">ul.true_breadcrumbs li:first-child:before</span> <span class="token punctuation">&#123;</span>
    <span class="token property">content</span><span class="token punctuation">:</span> <span class="token string">""</span><span class="token punctuation">;</span>
  <span class="token punctuation">&#125;</span>
</span></span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>style</span><span class="token punctuation">></span></span></code>`),s(t);var o=a(t,4),k=n(o);p(k,()=>`<code class="language-sql"><span class="token keyword">create</span> <span class="token operator">or</span> <span class="token keyword">replace</span> PACKAGE true_breadcrumbs <span class="token keyword">AS</span>
...
<span class="token keyword">END</span> true_breadcrumbs<span class="token punctuation">;</span></code>`),s(o);var l=a(o,4),d=n(l);p(d,()=>`<code class="language-sql"><span class="token keyword">create</span> <span class="token operator">or</span> <span class="token keyword">replace</span> PACKAGE BODY true_breadcrumbs <span class="token keyword">AS</span>
...
</code>`),s(l),_(r,c)}export{N as component};
