import{s as va,n as Z}from"../chunks/scheduler.63274e7e.js";import{S as Ea,i as fa,g as e,s as o,H as z,h as p,z as c,c as l,j as K,B as J,f as n,k as Q,a as t}from"../chunks/index.d9809aad.js";function xa(ma){let i,$=`I was getting irritated with breadcrumbs in APEX, specifically having to maintain a separate list for both breadcrumbs and “normal” navigation.<br/>
What I wanted was:`,I,r,aa="<li>every time you moved to a new page, remember the previous one as a parent</li> <li>if you move to a page you’d already been to, reset to that point.</li>",R,u,na="So when a new version of APEX came out, I looked into the new plug-in development feature, this is the result.",C,k,sa="The idea is simple, consisting of the following elements:",P,d,ta="<li>Add a Region to Page 0 of the application referencing the plug-in, this renders a new breadcrumb element on each render (page load)</li> <li>Add navigation to the application<ul><li>I used a list (which has no notion of breadcrumbs), implemented on each page for demonstration purposes</li> <li>This could equally well be chart navigation, interactive reports, etc</li></ul></li> <li>An APEX collection to store the current state of the breadcrumbs</li>",A,_,ea='For the record, I’m not suggesting that this is a particularly good approach, it doesn’t cater for session state management and it is another server process to execute, which will obviously affect performance, but <a href="https://apex.oracle.com/pls/apex/f?p=55790:1::::::" rel="nofollow">it works</a>.',H,g,pa="Creating a Plug-In",U,m,oa="Creating a plug-in is as simple as creating a package which exposes a function with the right signature, in this case, for a Region plug-in:",O,w,D,wa=`<code class="language-sql"><span class="token keyword">FUNCTION</span> render <span class="token punctuation">(</span>p_region              <span class="token operator">IN</span> apex_plugin<span class="token punctuation">.</span>t_region
  ...
  <span class="token keyword">RETURN</span> apex_plugin<span class="token punctuation">.</span>t_region_render_result</code>`,L,y,la=`Implementing the plug-in is even easier, simply add a plug-in Shared Component to the application, referencing the PL/SQL package, in this case:
Render Procedure/Function Name = true_breadcrumbs.render`,S,h,ca="The Code",B,b,ia="Page 0 Region Position 02 (didn’t have to be here)",F,v,ra="<li>Identification &gt; Title: True Breadcrumbs</li> <li>Identification &gt; Type: True Breadcrumbs [Plug-In]</li> <li>Header and Footer &gt; Header Text (this is only a demo, I wouldn’t normally add CSS directly in the HTML)</li>",M,E,q,ya=`<code class="language-html"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>style</span> <span class="token attr-name">type</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>text/css<span class="token punctuation">"</span></span><span class="token punctuation">></span></span><span class="token style"><span class="token language-css">
...
</code>`;return{c(){i=e("p"),i.innerHTML=$,I=o(),r=e("ul"),r.innerHTML=aa,R=o(),u=e("p"),u.textContent=na,C=o(),k=e("p"),k.textContent=sa,P=o(),d=e("ul"),d.innerHTML=ta,A=o(),_=e("p"),_.innerHTML=ea,H=o(),g=e("h3"),g.textContent=pa,U=o(),m=e("p"),m.textContent=oa,O=o(),w=e("pre"),D=new z(!1),L=o(),y=e("p"),y.textContent=la,S=o(),h=e("h3"),h.textContent=ca,B=o(),b=e("h5"),b.textContent=ia,F=o(),v=e("ul"),v.innerHTML=ra,M=o(),E=e("pre"),q=new z(!1),Y=o(),f=e("h5"),f.textContent=ua,G=o(),x=e("pre"),V=new z(!1),j=o(),N=e("h5"),N.textContent=ka,W=o(),T=e("pre"),X=new z(!1),this.h()},l(a){i=p(a,"P",{"data-svelte-h":!0}),c(i)!=="svelte-1g6o666"&&(i.innerHTML=$),I=l(a),r=p(a,"UL",{"data-svelte-h":!0}),c(r)!=="svelte-8yckyx"&&(r.innerHTML=aa),R=l(a),u=p(a,"P",{"data-svelte-h":!0}),c(u)!=="svelte-4agabx"&&(u.textContent=na),C=l(a),k=p(a,"P",{"data-svelte-h":!0}),c(k)!=="svelte-g9wjun"&&(k.textContent=sa),P=l(a),d=p(a,"UL",{"data-svelte-h":!0}),c(d)!=="svelte-1gr55ht"&&(d.innerHTML=ta),A=l(a),_=p(a,"P",{"data-svelte-h":!0}),c(_)!=="svelte-10ei818"&&(_.innerHTML=ea),H=l(a),g=p(a,"H3",{"data-svelte-h":!0}),c(g)!=="svelte-jvii0s"&&(g.textContent=pa),U=l(a),m=p(a,"P",{"data-svelte-h":!0}),c(m)!=="svelte-1vuhwpj"&&(m.textContent=oa),O=l(a),w=p(a,"PRE",{class:!0});var s=K(w);D=J(s,!1),s.forEach(n),L=l(a),y=p(a,"P",{"data-svelte-h":!0}),c(y)!=="svelte-nskdg5"&&(y.textContent=la),S=l(a),h=p(a,"H3",{"data-svelte-h":!0}),c(h)!=="svelte-10z4gvk"&&(h.textContent=ca),B=l(a),b=p(a,"H5",{"data-svelte-h":!0}),c(b)!=="svelte-cbsdtn"&&(b.textContent=ia),F=l(a),v=p(a,"UL",{"data-svelte-h":!0}),c(v)!=="svelte-15k52xp"&&(v.innerHTML=ra),M=l(a),E=p(a,"PRE",{class:!0});var da=K(E);q=J(da,!1),da.forEach(n),Y=l(a),f=p(a,"H5",{"data-svelte-h":!0}),c(f)!=="svelte-wyraul"&&(f.textContent=ua),G=l(a),x=p(a,"PRE",{class:!0});var _a=K(x);V=J(_a,!1),_a.forEach(n),j=l(a),N=p(a,"H5",{"data-svelte-h":!0}),c(N)!=="svelte-vqb5go"&&(N.textContent=ka),W=l(a),T=p(a,"PRE",{class:!0});var ga=K(T);X=J(ga,!1),ga.forEach(n),this.h()},h(){D.a=null,Q(w,"class","language-sql"),q.a=null,Q(E,"class","language-html"),V.a=null,Q(x,"class","language-sql"),X.a=null,Q(T,"class","language-sql")},m(a,s){t(a,i,s),t(a,I,s),t(a,r,s),t(a,R,s),t(a,u,s),t(a,C,s),t(a,k,s),t(a,P,s),t(a,d,s),t(a,A,s),t(a,_,s),t(a,H,s),t(a,g,s),t(a,U,s),t(a,m,s),t(a,O,s),t(a,w,s),D.m(wa,w),t(a,L,s),t(a,y,s),t(a,S,s),t(a,h,s),t(a,B,s),t(a,b,s),t(a,F,s),t(a,v,s),t(a,M,s),t(a,E,s),q.m(ya,E),t(a,Y,s),t(a,f,s),t(a,G,s),t(a,x,s),V.m(ha,x),t(a,j,s),t(a,N,s),t(a,W,s),t(a,T,s),X.m(ba,T)},p:Z,i:Z,o:Z,d(a){a&&(n(i),n(I),n(r),n(R),n(u),n(C),n(k),n(P),n(d),n(A),n(_),n(H),n(g),n(U),n(m),n(O),n(w),n(L),n(y),n(S),n(h),n(B),n(b),n(F),n(v),n(M),n(E),n(Y),n(f),n(G),n(x),n(j),n(N),n(W),n(T))}}}class Ia extends Ea{constructor(i){super(),fa(this,i,null,xa,va,{})}}export{Ia as component};
