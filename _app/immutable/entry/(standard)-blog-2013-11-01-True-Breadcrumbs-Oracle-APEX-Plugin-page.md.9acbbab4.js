import{S as ys,i as ws,s as fs,k as p,q as c,a as r,l as o,m as l,r as i,h as s,c as u,n as O,b as t,I as n,C as Ga}from"../chunks/index.de0bb5b5.js";function bs(is){let k,ua,ka,da,V,m,D,_a,ma,B,ga,W,v,ha,K,I,ya,Q,d,F,wa,fa,N,ba,h,H,Ea,va,M,Ia,Na,q,Ta,J,g,Pa,y,Ra,xa,j,T,Aa,z,P,La,Z,w,rs=`<code class="language-sql"><span class="token keyword">FUNCTION</span> render <span class="token punctuation">(</span>p_region              <span class="token operator">IN</span> apex_plugin<span class="token punctuation">.</span>t_region
  ...
  <span class="token keyword">RETURN</span> apex_plugin<span class="token punctuation">.</span>t_region_render_result</code>`,$,R,Ua,aa,x,Sa,sa,A,Ca,na,_,Y,Oa,Da,G,Ba,Fa,X,Ha,ea,f,us=`<code class="language-html"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>style</span> <span class="token attr-name">type</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>text/css<span class="token punctuation">"</span></span><span class="token punctuation">></span></span><span class="token style"><span class="token language-css">
...
Render Procedure/Function Name = true_breadcrumbs.render`),aa=r(),x=p("h3"),Sa=c("The Code"),sa=r(),A=p("h5"),Ca=c("Page 0 Region Position 02 (didn’t have to be here)"),na=r(),_=p("ul"),Y=p("li"),Oa=c("Identification > Title: True Breadcrumbs"),Da=r(),G=p("li"),Ba=c("Identification > Type: True Breadcrumbs [Plug-In]"),Fa=r(),X=p("li"),Ha=c("Header and Footer > Header Text (this is only a demo, I wouldn’t normally add CSS directly in the HTML)"),ea=r(),f=p("pre"),ta=r(),L=p("h5"),Ma=c("Package header"),pa=r(),b=p("pre"),oa=r(),U=p("h5"),qa=c("Package body"),la=r(),E=p("pre"),this.h()},l(a){k=o(a,"P",{});var e=l(k);ua=i(e,"I was getting irritated with breadcrumbs in APEX, specifically having to maintain a separate list for both breadcrumbs and “normal” navigation."),ka=o(e,"BR",{}),da=i(e,`
What I wanted was:`),e.forEach(s),V=u(a),m=o(a,"UL",{});var ca=l(m);D=o(ca,"LI",{});var Xa=l(D);_a=i(Xa,"every time you moved to a new page, remember the previous one as a parent"),Xa.forEach(s),ma=u(ca),B=o(ca,"LI",{});var Va=l(B);ga=i(Va,"if you move to a page you’d already been to, reset to that point."),Va.forEach(s),ca.forEach(s),W=u(a),v=o(a,"P",{});var Wa=l(v);ha=i(Wa,"So when a new version of APEX came out, I looked into the new plug-in development feature, this is the result."),Wa.forEach(s),K=u(a),I=o(a,"P",{});var Ka=l(I);ya=i(Ka,"The idea is simple, consisting of the following elements:"),Ka.forEach(s),Q=u(a),d=o(a,"UL",{});var S=l(d);F=o(S,"LI",{});var Qa=l(F);wa=i(Qa,"Add a Region to Page 0 of the application referencing the plug-in, this renders a new breadcrumb element on each render (page load)"),Qa.forEach(s),fa=u(S),N=o(S,"LI",{});var Ya=l(N);ba=i(Ya,"Add navigation to the application"),h=o(Ya,"UL",{});var ia=l(h);H=o(ia,"LI",{});var Ja=l(H);Ea=i(Ja,"I used a list (which has no notion of breadcrumbs), implemented on each page for demonstration purposes"),Ja.forEach(s),va=u(ia),M=o(ia,"LI",{});var ja=l(M);Ia=i(ja,"This could equally well be chart navigation, interactive reports, etc"),ja.forEach(s),ia.forEach(s),Ya.forEach(s),Na=u(S),q=o(S,"LI",{});var za=l(q);Ta=i(za,"An APEX collection to store the current state of the breadcrumbs"),za.forEach(s),S.forEach(s),J=u(a),g=o(a,"P",{});var ra=l(g);Pa=i(ra,"For the record, I’m not suggesting that this is a particularly good approach, it doesn’t cater for session state management and it is another server process to execute, which will obviously affect performance, but "),y=o(ra,"A",{href:!0,rel:!0});var Za=l(y);Ra=i(Za,"it works"),Za.forEach(s),xa=i(ra,"."),ra.forEach(s),j=u(a),T=o(a,"H3",{});var $a=l(T);Aa=i($a,"Creating a Plug-In"),$a.forEach(s),z=u(a),P=o(a,"P",{});var as=l(P);La=i(as,"Creating a plug-in is as simple as creating a package which exposes a function with the right signature, in this case, for a Region plug-in:"),as.forEach(s),Z=u(a),w=o(a,"PRE",{class:!0});var _s=l(w);_s.forEach(s),$=u(a),R=o(a,"P",{});var ss=l(R);Ua=i(ss,`Implementing the plug-in is even easier, simply add a plug-in Shared Component to the application, referencing the PL/SQL package, in this case:
Render Procedure/Function Name = true_breadcrumbs.render`),ss.forEach(s),aa=u(a),x=o(a,"H3",{});var ns=l(x);Sa=i(ns,"The Code"),ns.forEach(s),sa=u(a),A=o(a,"H5",{});var es=l(A);Ca=i(es,"Page 0 Region Position 02 (didn’t have to be here)"),es.forEach(s),na=u(a),_=o(a,"UL",{});var C=l(_);Y=o(C,"LI",{});var ts=l(Y);Oa=i(ts,"Identification > Title: True Breadcrumbs"),ts.forEach(s),Da=u(C),G=o(C,"LI",{});var ps=l(G);Ba=i(ps,"Identification > Type: True Breadcrumbs [Plug-In]"),ps.forEach(s),Fa=u(C),X=o(C,"LI",{});var os=l(X);Ha=i(os,"Header and Footer > Header Text (this is only a demo, I wouldn’t normally add CSS directly in the HTML)"),os.forEach(s),C.forEach(s),ea=u(a),f=o(a,"PRE",{class:!0});var ms=l(f);ms.forEach(s),ta=u(a),L=o(a,"H5",{});var ls=l(L);Ma=i(ls,"Package header"),ls.forEach(s),pa=u(a),b=o(a,"PRE",{class:!0});var gs=l(b);gs.forEach(s),oa=u(a),U=o(a,"H5",{});var cs=l(U);qa=i(cs,"Package body"),cs.forEach(s),la=u(a),E=o(a,"PRE",{class:!0});var hs=l(E);hs.forEach(s),this.h()},h(){O(y,"href","https://apex.oracle.com/pls/apex/f?p=55790:1::::::"),O(y,"rel","nofollow"),O(w,"class","language-sql"),O(f,"class","language-html"),O(b,"class","language-sql"),O(E,"class","language-sql")},m(a,e){t(a,k,e),n(k,ua),n(k,ka),n(k,da),t(a,V,e),t(a,m,e),n(m,D),n(D,_a),n(m,ma),n(m,B),n(B,ga),t(a,W,e),t(a,v,e),n(v,ha),t(a,K,e),t(a,I,e),n(I,ya),t(a,Q,e),t(a,d,e),n(d,F),n(F,wa),n(d,fa),n(d,N),n(N,ba),n(N,h),n(h,H),n(H,Ea),n(h,va),n(h,M),n(M,Ia),n(d,Na),n(d,q),n(q,Ta),t(a,J,e),t(a,g,e),n(g,Pa),n(g,y),n(y,Ra),n(g,xa),t(a,j,e),t(a,T,e),n(T,Aa),t(a,z,e),t(a,P,e),n(P,La),t(a,Z,e),t(a,w,e),w.innerHTML=rs,t(a,$,e),t(a,R,e),n(R,Ua),t(a,aa,e),t(a,x,e),n(x,Sa),t(a,sa,e),t(a,A,e),n(A,Ca),t(a,na,e),t(a,_,e),n(_,Y),n(Y,Oa),n(_,Da),n(_,G),n(G,Ba),n(_,Fa),n(_,X),n(X,Ha),t(a,ea,e),t(a,f,e),f.innerHTML=us,t(a,ta,e),t(a,L,e),n(L,Ma),t(a,pa,e),t(a,b,e),b.innerHTML=ks,t(a,oa,e),t(a,U,e),n(U,qa),t(a,la,e),t(a,E,e),E.innerHTML=ds},p:Ga,i:Ga,o:Ga,d(a){a&&s(k),a&&s(V),a&&s(m),a&&s(W),a&&s(v),a&&s(K),a&&s(I),a&&s(Q),a&&s(d),a&&s(J),a&&s(g),a&&s(j),a&&s(T),a&&s(z),a&&s(P),a&&s(Z),a&&s(w),a&&s($),a&&s(R),a&&s(aa),a&&s(x),a&&s(sa),a&&s(A),a&&s(na),a&&s(_),a&&s(ea),a&&s(f),a&&s(ta),a&&s(L),a&&s(pa),a&&s(b),a&&s(oa),a&&s(U),a&&s(la),a&&s(E)}}}class vs extends ys{constructor(k){super(),ws(this,k,null,bs,fs,{})}}export{vs as default};
