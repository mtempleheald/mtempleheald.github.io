import{S as ys,i as ws,s as fs,e as p,t as c,k as r,c as o,a as l,h as i,d as s,m as u,b as C,g as t,F as n,G as Ga}from"../../../../../chunks/vendor-4dad5814.js";function bs(is){let k,ua,ka,da,V,m,D,_a,ma,B,ga,W,v,ha,K,I,ya,Q,d,F,wa,fa,N,ba,h,H,Ea,va,M,Ia,Na,q,Ta,j,g,Pa,y,Ra,xa,J,T,Aa,z,P,La,Z,w,rs=`<code class="language-sql"><span class="token keyword">FUNCTION</span> render <span class="token punctuation">(</span>p_region              <span class="token operator">IN</span> apex_plugin<span class="token punctuation">.</span>t_region
